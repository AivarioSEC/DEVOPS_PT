...
CREATE TABLE IF NOT EXISTS emails(id SERIAL PRIMARY KEY, emails VARCHAR(70) NOT NULL);
CREATE TABLE IF NOT EXISTS phones(id SERIAL PRIMARY KEY, phones VARCHAR(70) NOT NULL);